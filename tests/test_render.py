...
def test_hostile_title_renders_as_text_only():
    ...
    assert parsed.tags.count("script") == 10 and "img" not in parsed.tags  # S11/S18 gates, S27 tabs.js, S25 reader.js, S18 offline+sw, S24 story-actions.js, S14 coverage-view.js, S15 history/observe.js, S33 live-actions.js
...
def test_page_has_no_images_or_scripts():
    ...
    ]  # S11/S18 gates, S27 tabs, S25 reader, S24 story-actions, S14 coverage-view, S15 history, S33 live-actions, S18 offline+sw
